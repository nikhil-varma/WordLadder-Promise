...
Writing approach documentation and making sure that the code is well documented. The advantage here is that the approach documentation will help 
anticipate issues and problems at the most earliest stage and allow handling them without future issues


* What’s one cool feature or idea you’d like to implement if you came to work for us?
An integration system using ReactJs which will allow pooling resources and journals from other places making Neliti the Google for Journals
